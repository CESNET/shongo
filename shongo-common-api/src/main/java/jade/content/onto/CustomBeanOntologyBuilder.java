...
/**
 * Copy of {@link BeanOntologyBuilder} with modified {@link #getSchemaNameFromClass(Class)}.
 *
 * @author Martin Srom <martin.srom@cesnet.cz>
 */
class CustomBeanOntologyBuilder
{
    ...
    private static Pattern CLASS_NAME_PATTERN = Pattern.compile("cz\\.cesnet\\.shongo\\.(.+)\\.api.*\\.(.+)");
