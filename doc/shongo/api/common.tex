...
%Each user that accesses shongo or participates in shongo managed videoconference should be identified by \ApiRef{UserIdentity} definition.
...
\todo{Reference user identity in Person class}
...
\ApiClassAttribute{audioMuted}{boolean}{}
Is the user audio-muted?
\ApiClassAttribute{videoMuted}{boolean}{}
