...
\ApiClassAttribute{withAlias}{boolean}{\ApiOptional} Specifies whether \ApiRef{Alias} should be acquired for each \ApiRef{Technology} from \ApiCode{technologies}.
...
\begin{ApiClassAttributes}
\ApiClassAttribute{aliasValue}{String}{} Allocated value for one or multiple \glspl{g:device-alias}.
