...
\begin{ApiClassAttributes}
\ApiClassAttributeCollection{slots}{List}{DateTimeSlot}{\ApiRequired} List of requested |slots|.
\ApiClassAttributeCollection{specifications}{List}{Specification}{\ApiRequired} List of requested |specifications|.
\ApiClassAttributeCollection{reservationRequests}{List}{ReservationRequest}{\ApiRequired} List of already created |ReservationRequest|s.
\end{ApiClassAttributes}
...
\begin{ApiClassAttributes}
\ApiClassAttributeCollection{endpoints}{List}{CompartmentReservation.Endpoint}{} List of participating \glspl{g:endpoint}.
\ApiClassAttributeCollection{virtualRooms}{List}{CompartmentReservation.VirtualRoom}{} List of \glspl{g:device-virtual-room}.
\ApiClassAttributeCollection{connections}{List}{CompartmentReservation.Connection}{} List of connection between \glspl{g:endpoint} and \glspl{g:device-virtual-room}.
\end{ApiClassAttributes}
