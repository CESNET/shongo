...
\ApiClass{VirtualRoomSpecification}{Specification}
Represents a specification for a \gls{g:device-virtual-room}.
\begin{ApiClassAttributes}
\ApiClassAttributeCollection{technologies}{Set}{Technology}{\ApiOptional} Set of \glspl{g:technology} which the \gls{g:device-virtual-room} must support.
\ApiClassAttribute{portCount}{int}{\ApiOptional} Number of ports which must be allocated for the \gls{g:device-virtual-room}.
\ApiClassAttribute{resourceIdentifier}{String}{\ApiOptional} Identifier of a preferred \gls{g:resource-device} with \ApiCode{VirtualRoomsCapability} where should be the \gls{g:device-virtual-room} created.
\end{ApiClassAttributes}
...
\begin{ApiClassAttributes}
\ApiClassAttribute{identifier}{String}{} Unique identifier of the \gls{g:executor} plan.
...
\ApiClass{VirtualRoom}{Executable}
Represents an \gls{g:executor} plan for a \gls{g:device-virtual-room}.
\begin{ApiClassAttributes}
\ApiClassAttribute{portCount}{int}{} Number of available ports in the \gls{g:device-virtual-room}
\ApiClassAttribute{resourceIdentifier}{String}{} Identifier of \gls{g:resource-device} in which the \gls{g:device-virtual-room} will be started.
\ApiClassAttribute{state}{Executable.State}{} Current state of the \gls{g:executor} plan.
\end{ApiClassAttributes}

\ApiClass{Compartment}{Executable}
