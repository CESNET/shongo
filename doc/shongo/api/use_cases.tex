...
shongo:<domain>:<id>
\end{verbatim}
The |<domain>| component represents the full name of a \gls{g:domain} to which the entity belongs (or where it was created in case of \gls{g:reservation}). Each \gls{g:domain} will run it's own \gls{g:controller}. The |<id>| component represents an identification of the entity in the specified \gls{g:domain}.
