...
\begin{ApiEnumValues}
\ApiEnumValue{Description}{} Some description of the room.
\ApiEnumValue{Pin}{} PIN that must be entered to get to the room.
\ApiEnumValue{ListedPublicly}{} Whether to list the room in public lists. Defaults to false.
\ApiEnumValue{AllowContent}{} Whether participants may contribute content. Defaults to true.
\ApiEnumValue{AllowGuests}{} Whether guests should be allowed to join. Defaults to true.
\ApiEnumValue{JoinAudioMuted}{} Whether audio should be muted on join. Defaults to false.
\ApiEnumValue{JoinVideoMuted}{} Whether video should be muted on join. Defaults to false.
\ApiEnumValue{RegisterWithH323Gatekeeper}{} Whether to register the aliases with the gatekeeper. Defaults to false.
\ApiEnumValue{RegisterWithSIPRegistrar}{} Whether to register the aliases with the SIP registrar. Defaults to false.
\ApiEnumValue{StartLocked}{} Whether the room should be locked when started. Defaults to false.
\ApiEnumValue{ConferenceMeEnabled}{} Whether the ConferenceMe should be enabled for the room. Defaults to false.
\end{ApiEnumValues}
...
\ApiItem{\ApiCode{modifyRoom(String roomId, Map<String,Object> attributes, Map<Room.Option,Object> options)}}
Modifies a room identified by \ApiCode{roomId}. The \ApiCode{attributes} and \ApiCode{options} maps specify \ApiCode{Room} attribute names and options, respectivelly, mapped to new values. Any attribute or option value may be \ApiCode{null} which means it should be unset.
