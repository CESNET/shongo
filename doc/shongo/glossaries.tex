...
{
  name=preprocessor,
  description={Preprocessor is a component of a \gls{g:controller} which creates
    single \glspl{g:reservation-request} from compound requests. Single 
    \glspl{g:reservation-request} can be allocated by the \gls{g:scheduler} but 
    compound requests cannot be.}
}
