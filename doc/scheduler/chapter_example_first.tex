...
\TODO{Move Example 1 to Example 2 and as Example 1 show the simplest scenario of reserving only 3 unknown terminals. The scheduler should plan the meeting to a single MCU from resource database.}
