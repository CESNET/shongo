...
\begin{ApiEnumValues}
\ApiEnumValue{EndPoint} A managed or unmanaged endpoint.
\ApiEnumValue{Server} A managed infrastructure element.
\ApiEnumValue{Room} A virtual room.
\ApiEnumValue{License}
\ApiEnumValue{Identifier}
\ApiEnumValue{Reservation}
\ApiEnumValue{Other} A physical room.
\end{ApiEnumValues}
...
\ApiClassAttribute{managed}{Boolean} Specify if resource is managed and scheluded by Shongo.
\ApiClassAttribute{type}{ResourceType} Type or capabilities of the resource, see |ResourceType|. 
