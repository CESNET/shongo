...
\ApiClassAttribute{creation}{AbsoluteDateTime}{} Date and time when the room was created. \TODO{Is that what the use case \ref{UC:ops:room:shongo-options} mentions? What does the "on Shongo level" mean?}
\ApiClassAttribute{type}{String}{} Type of the room. \TODO{Which types of rooms are to be considered? H.323/SIP/Connect/...? Or some other types?}
\end{ApiClassAttributes}
