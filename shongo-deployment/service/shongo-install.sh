...
BIN="java -jar $DEPLOYMENT_DIR/../shongo-controller/target/shongo-controller-:VERSION:.jar --daemon -Dfile.encoding=UTF-8"
...
BIN="java -jar $DEPLOYMENT_DIR/../shongo-connector/target/shongo-connector-:VERSION:.jar --daemon -Dfile.encoding=UTF-8"
...
BIN="java -jar $DEPLOYMENT_DIR/../shongo-client-web/target/shongo-client-web-:VERSION:.jar --daemon -Dfile.encoding=UTF-8"
