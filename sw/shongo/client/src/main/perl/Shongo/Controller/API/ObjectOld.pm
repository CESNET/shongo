...
#
package Shongo::Controller::API::ObjectOld;
...
sub create_attributes
{
    ...
    $attributes->{'add_collection'} = sub{
        ...
        my $collection = Shongo::Controller::API::ObjectOld::create_collection($name);
...
sub to_string
{
    ...
    return Shongo::Controller::API::ObjectOld::format_attributes($attributes, $self->get_name());
}
