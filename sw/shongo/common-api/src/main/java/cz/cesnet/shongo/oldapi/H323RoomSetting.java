...
/**
 * Represents a {@link cz.cesnet.shongo.oldapi.RoomSetting} for a {@link cz.cesnet.shongo.Technology#H323}.
 *
...
public class H323RoomSetting extends RoomSetting
{
     ...
     * @return this {@link cz.cesnet.shongo.oldapi.H323RoomSetting}
     */
    public cz.cesnet.shongo.oldapi.H323RoomSetting withPin(String pin)
    {
        setPin(pin);
        return this;
    }
