...
{
    /**
     * The code of the room which is uniquely generated by a controller when new room should be created.
     * Connectors can use this value as a new room identifier when creating a room (or they can generate theirs
     * own identifier and do not use the code).
     *
     * This value don't have to be filled when connector should return info about room (can be lefts empty).
     */
    ...
    /**
     * @return code of the room, i.e. a unique identifier generated by Shongo (or induced by a room alias)
     */
    public String getCode()
    {
        return getPropertyStorage().getValue(CODE);
    }

    /**
     * @param code code of the room, i.e. a unique identifier generated by Shongo (or induced by a room alias)
     */
    public void setCode(String code)
    {
        ...
        getPropertyStorage().setValue(CODE, code);
    }
