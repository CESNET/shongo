...
public class Cache extends Component implements Component.EntityManagerFactoryAware
{
    ...
    {
        return resourceCache.isResourceAvailable(resource, interval, transaction)
                && resourceCache.isDependentResourcesAvailable(resource, interval, transaction);
    }
    ...
    public List<AvailableRoom> findAvailableRooms(Interval interval, int requiredLicenseCount,
            Set<Technology> technologies, CacheTransaction transaction)
    {
        ...
        for (Long deviceResourceId : deviceResourceIds) {
            ...
            AvailableRoom availableRoom = resourceCache.getAvailableRoom(deviceResource, interval, transaction);
     ...
     */
    public List<AvailableRoom> findAvailableRooms(Interval interval, int requiredLicenseCount,
            Technology[] technologies, CacheTransaction transaction)
    {
