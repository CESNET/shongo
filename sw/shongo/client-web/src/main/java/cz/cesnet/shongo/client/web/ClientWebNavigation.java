...
public enum ClientWebNavigation
{
    ...
    RESERVATION_REQUEST_PARTICIPANT_CREATE(RESERVATION_REQUEST,
            ClientWebUrl.RESERVATION_REQUEST_PARTICIPANT_CREATE,
            "navigation.reservationRequest.detail.participantCreate"),
    RESERVATION_REQUEST_PARTICIPANT_MODIFY(RESERVATION_REQUEST,
            ClientWebUrl.RESERVATION_REQUEST_PARTICIPANT_MODIFY,
            "navigation.reservationRequest.detail.participantModify"),
    RESERVATION_REQUEST_PARTICIPANT_DELETE(RESERVATION_REQUEST,
            ClientWebUrl.RESERVATION_REQUEST_PARTICIPANT_DELETE,
            "navigation.reservationRequest.detail.participantDelete"),

    USER_ROLE_LIST(HOME, ClientWebUrl.USER_ROLE_LIST,
            "navigation.userRole.list"),
    USER_ROLE_CREATE(USER_ROLE_LIST, ClientWebUrl.USER_ROLE_CREATE,
            "navigation.userRole.create"),
    USER_ROLE_DELETE(USER_ROLE_LIST, ClientWebUrl.USER_ROLE_DELETE,
            "navigation.userRole.delete"),
