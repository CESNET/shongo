...
<tag:url var="roomReservationsUrl" value="<%= ClientWebUrl.MEETING_ROOM_RESERVATION_LIST_DATA %>"/>
...
<script type="text/javascript">
    ...
    module.controller("CalendarController", function ($scope, $compile, $application, uiCalendarConfig) {
        ...
        $scope.eventsF = function(start, end, timezone, callback) {
            ...
            $.ajax("${roomReservationsUrl}?interval-from=" + start.format() + "&interval-to=" + end.format() + "&resource-id=" + resourceId, {
                dataType: "json"
            }).done(function (data) {
                var events = [];
