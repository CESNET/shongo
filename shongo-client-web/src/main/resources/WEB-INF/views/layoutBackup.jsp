            ...
            <ul class="nav pull-right">
                ...
                <li>
                    <span class="navbar-text">
                        <a id="language-english" href="${languageUrl.replaceAll(":lang", "en")}"><img class="language" src="${contextPath}/WEB-INF/default-design/img/i18n/en.png" alt="English" title="English"/></a>
                        <a id="language-czech" href="${languageUrl.replaceAll(":lang", "cs")}"><img class="language" src="${contextPath}/WEB-INF/default-design/img/i18n/cs.png" alt="Česky" title="Česky"/></a>
                    </span>
                </li>
            </ul>
    ...
    <div class="footer block">
        <p class="muted">
            ...
            <a title="CESNET" href="http://www.cesnet.cz/">
                <img src="${contextPath}/WEB-INF/default-design/img/cesnet.gif" alt="CESNET, z.s.p.o."/>
            </a>
        </p>
    </div>
